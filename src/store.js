    ...
    courses: {
      html: {
        ...
        lessons: [
          {
            title: "Основы основ",
            preview_text: 'Что такое HTML и CSS? HTML (HyperText Markup Language, язык разметки гипертекста) задаёт структуру содержимого и его смысл, определяя такой контент как, к примеру, заголовки, абзацы или изображения. CSS или...',
            text:
          ...
          {
            title: "Основные теги",
            preview_text: 'Теперь на нашей странице есть "Привет, мир!", обернутый в тег <code>&lt;p&gt;</code>. Этот тег нужен для того, чтобы хранить внутри абзацы текста. Давайте попробуем сделать из абзаца заголовок. Есть несколько типов - h1-h6...',
            text:
          ...
          {
            title: "Формы ввода",
            preview_text: 'Формы ввода помогают пользователю вводить данные любого типа. Позже мы научимся отправлять их на сервер и обрабатывать, но сейчас, мы познакомися с тегами, которые помогут нам создать простейшую форму входа...',
            text:
